...
- Visual Studio Code
- Just make an HTML file and open it in the browser
- How to deploy a static HTML file for free
- CodePen / JSFiddle
...
- JSFiddle for quick prototyping
- Valtown is the JSFiddle of backend
